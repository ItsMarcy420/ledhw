...
// SSID & Password
const char* ssid = "23561398";
const char* password = "nicole1212";
#define ledbtn=12;
#define ledbtn2=14;
    ...
    <head>\
      <style>\
        body{ display: flex; flex-direction: column;}\
         a { color: #000;background: #CEF2F4; width: 200px; height: 50px; margin: 20px; font-size: 30pt; text-decoration: none;border: 2px solid  #000;border-radius: 5px; display: flex;justify-content:center;}\
      </style>\
    </head>\
    <body>\
    ...
    <head>\
      <style>\
        body{ display: flex; flex-direction: column;}\
         ...
         h1{ color: #fff; background: cornflowerblue; width: 200px; height: 50px; margin: 20px; font-size: 24pt; text-decoration: none;border-radius: 5px; display: flex;justify-content:center;}\
      </style>\
    </head>\
    <body>\
      <h1>LED OPEN</h1>\
